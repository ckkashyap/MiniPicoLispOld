...
any doSDL(any x)
{
    ...
    DL_LOADER_HANDLE = dlopen("libglue.so", RTLD_NOW);
    ...
    RENDERER = (RENDERER_TYPE)dlsym(DL_LOADER_HANDLE, "SDL_GLUE_Init");
    DRAWLINE = (DRAWLINE_TYPE)dlsym(DL_LOADER_HANDLE, "SDL_GLUE_DrawLine");
    CLEAR = (CLEAR_TYPE)dlsym(DL_LOADER_HANDLE, "SDL_GLUE_Clear");
    SWAP =  (SWAP_TYPE)dlsym(DL_LOADER_HANDLE, "SDL_GLUE_Swap");
    COLOR =  (COLOR_TYPE)dlsym(DL_LOADER_HANDLE, "SDL_GLUE_Color");
